...
<header>
                    ...
                    <ul class="list-inline">
                        <li>
                            ...
                            <label class="d-none d-md-inline-block d-lg-inline-block d-xl-inline-block"><a
                                    href="mailto:"
                                    class="text-white">info@cloudyzx.com</a></label>
                        </li>
                        <li>
    ...
    <div class="container indexpage">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <a class="navbar-brand" href="{{ route('home') }}"><img src="{{ asset('assets/images/logo.png') }}" alt="logo" style="width: 120px;height: 50px;"></a>
...
<!--                    <li class=" nav-item dropdown {!! (Request::is('aboutus') || Request::is('timeline') || Request::is('faq') || Request::is('blank_page')  ? 'active' : '') !!}">
                    ...
                    <li class="nav-item {!! (Request::is(
                    'timeline') ? 'active' : '') !!}"><a href="{{ URL::to('timeline') }}" class="nav-link">Timeline</a>
                    </li>    
                    <li class="nav-item {!! (Request::is(
                    'aboutus') ? 'active' : '') !!}"><a href="{{ URL::to('aboutus') }}" class="nav-link">About Us</a>
                    </li>             
        ...
        <div class="footer-text">
            ...
            <div class="row">
                <div class="col-sm-4 col-lg-4 col-md-4 col-12">
                    <h4>About Us</h4>
                    <p>
                        CloudyZx Pvt. Ltd. is the best website and software development company to transform your business 
                        through the power of best enterprise IT solutions that comprises of the full range of digital marketing 
                        (SEO, SMO, PPC etc.), mobile app, website ,software and eCommerce development services. Whatever your 
                        envision for your business, we bring it into reality through clever and innovative use of technology.
                    </p>
                    <!--<hr id="hr_border2">-->
<!--                    <h4 class="menu">Follow Us</h4>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4 col-12">
                    ...
                    <ul class="list-unstyled">
                        <li>C-28,Sector 2, Central Market</li>
...
<!--                    <div class="media">
                        <img class="media-object rounded-circle mr-3" src="{{ asset('assets/images/sanjeev.jpg') }}"
                             alt="image">
                        <div class="media-body">
                            <p class="media-heading text-justify">Your work is going to fill a large part of your life, and the only way to be truly satisfied is to do what you believe is great work. And the only way to do great work is to love what you do.</p>
                            <p class="text-right"><i>Sanjeev Tyagi</i></p>
                        </div>
                    </div>-->
                    <div class="media">
                        <img class="media-object rounded-circle mr-3" src="{{ asset('assets/images/anuj.jpg') }}"
                             alt="image">

                        <div class="media-body">
                            <p class="media-heading text-justify">Twenty years from now you will be more disappointed by the things that you didn’t do than by the ones you did do. So throw off the bowlines. Sail away from the safe harbor. Catch the trade winds in your sails. Explore. Dream. Discover.</p>
                            <p class="text-right"><i>Dr. Anuj Bhardwaj</i></p>
                        </div>
                    </div>
...
<div class=" col-12 copyright">
    <div class="container">
        <p>Copyright &copy; CloudyZx Pvt. Ltd., 2019</p>
    </div>
</div>
</footer>
